package vk.api {
  ...
  public class DataProvider {    
    ...
    private var _test_mode: int;
    
    private var _global_options: Object;
    
    
    
    public function DataProvider(api_url: String, api_id: Number, api_sid: String, api_secret: String, viewer_id: Number, test_mode: int = 0) {
    ...
    private function _sendRequest(method:String, options:Object):void {
      ...
      request_params["test_mode"] = _test_mode;
